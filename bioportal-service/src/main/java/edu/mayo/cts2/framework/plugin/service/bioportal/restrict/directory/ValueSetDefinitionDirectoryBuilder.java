...
/**
 * The Class ValueSetDefinitionDirectoryBuilder.
 *
 * @author <a href="mailto:kevin.peterson@mayo.edu">Kevin Peterson</a>
 */
public class ValueSetDefinitionDirectoryBuilder extends AbstractRemovingDirectoryBuilder<ValueSetDefinitionDirectoryEntry,ValueSetDefinitionDirectoryEntry> {

	/**
	 * Instantiates a new value set definition directory builder.
	 *
	...
	public ValueSetDefinitionDirectoryBuilder(
			...
			List<ResolvableModelAttributeReference<ValueSetDefinitionDirectoryEntry>> 
	...
	protected List<ValueSetDefinitionDirectoryEntry> transformResults(
			List<ValueSetDefinitionDirectoryEntry> results) {
		return results;
	}
}
